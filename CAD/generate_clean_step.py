...
paths = ['/home/sean/cli_model.stp', '/home/sean/master_model.stp', '/mnt/c/Users/Sean/Documents/AILangSH/cli_model.stp', '/mnt/c/Users/Sean/Documents/AILangSH/master_model.stp']
for p in paths:
    with open(p, 'w') as f:
        f.write(content)
    print(f"Wrote clean STEP file: {p}")
